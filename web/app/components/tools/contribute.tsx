...
const Contribute: FC = () => {
  ...
  return (
    <div className='shrink-0 p-2'>
      ...
      <a href='https://github.com/Kattgatt/dify/blob/main/CONTRIBUTING.md' target='_blank' rel='noopener noreferrer' className='mt-1 flex items-center space-x-1 text-[#155EEF]'>
